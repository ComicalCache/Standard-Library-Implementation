...
BOOST_AUTO_TEST_CASE(Vector_Copy_Vector_Insert_Method) {
    ext::vector<int> vec1({0, 3, 4, 5});
    ext::vector<std::string> vec2({"0", "3", "4", "5"});
    ext::vector<testObj> vec3({testObj(0), testObj(3), testObj(4), testObj(5)});
...
BOOST_AUTO_TEST_CASE(Vector_Move_Vector_Insert_Method) {
    ext::vector<int> vec1({0, 3, 4, 5});
    ext::vector<std::string> vec2({"0", "3", "4", "5"});
    ext::vector<testObj> vec3({testObj(0), testObj(3), testObj(4), testObj(5)});

    vec1.insert(1, ext::vector<int>({1, 2}));
    vec2.insert(1, ext::vector<std::string>({"1", "2"}));
    vec3.insert(1, ext::vector<testObj>({testObj(1), testObj(2)}));
...
BOOST_AUTO_TEST_CASE(Vector_Copy_Vector_Push_Back_Method) {
...
BOOST_AUTO_TEST_CASE(Vector_Move_Vector_Push_Back_Method) {
    ext::vector<int> vec1({0, 1, 2, 3});
    ext::vector<std::string> vec2({"0", "1", "2", "3"});
    ext::vector<testObj> vec3({testObj(0), testObj(1), testObj(2), testObj(3)});

    vec1.push_back(ext::vector<int>({4, 5}));
    vec2.push_back(ext::vector<std::string>({"4", "5"}));
    vec3.push_back(ext::vector<testObj>({testObj(4), testObj(5)}));
